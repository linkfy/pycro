...
TITLE = "Click Diagnostic: MIDDLE"
BUTTON = pycro.KEY.MOUSE_MIDDLE
...
def update(dt: float) -> None:
    ...
    pycro.put_pixel(mouse_x, mouse_y, (0.55, 0.55, 1.0, 1.0))
    pycro.draw_line(mouse_x - 6.0, mouse_y, mouse_x + 6.0, mouse_y, (0.55, 0.55, 1.0, 1.0))
    pycro.draw_line(mouse_x, mouse_y - 6.0, mouse_x, mouse_y + 6.0, (0.55, 0.55, 1.0, 1.0))

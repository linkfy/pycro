...
TITLE = "Click Diagnostic: RIGHT"
BUTTON = pycro.KEY.MOUSE_RIGHT
...
def update(dt: float) -> None:
    ...
    pycro.put_pixel(mouse_x, mouse_y, (0.2, 1.0, 0.35, 1.0))
    pycro.draw_line(mouse_x - 6.0, mouse_y, mouse_x + 6.0, mouse_y, (0.2, 1.0, 0.35, 1.0))
    pycro.draw_line(mouse_x, mouse_y - 6.0, mouse_x, mouse_y + 6.0, (0.2, 1.0, 0.35, 1.0))

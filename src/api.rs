...
/// The optional setup function name.
pub const SETUP_FUNCTION: &str = "setup";
...
pub fn render_stub(spec: &ModuleSpec) -> String {
    ...
    writeln!(
        output,
        "\"\"\"Generated stubs for `{}`.\n\nDo not edit this file manually.\nThe engine loads `{}` and dispatches optional `{}` plus required `{}(dt)`.\n\"\"\"",
        MODULE_NAME, ENTRYPOINT_SCRIPT, SETUP_FUNCTION, UPDATE_FUNCTION
    )

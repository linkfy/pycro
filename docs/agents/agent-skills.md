...
| --- | --- | --- | --- | --- | --- |
| architecture-orchestrator | orchestration-contract | architecture-review | `docs/agents/skills/orchestration-contract.md`, `docs/agents/skills/architecture-review.md` | any implementation, delegation, integration, or gate workflow | isolated read-only exploration |
| phase-planner | docs-tracker-contract | architecture-review | `docs/agents/skills/docs-tracker-contract.md`, `docs/agents/skills/architecture-review.md` | a new phase starts or scope changes materially | phase is execution-only with locked requirements |

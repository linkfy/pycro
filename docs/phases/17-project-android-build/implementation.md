...
| --- | --- | --- | --- | --- | --- | --- |
| project-android-build | architecture-orchestrator | runtime-worker, platform-worker, api-worker, docs-tracker, qa-reviewer, commit-steward | planned | codex/17-project-android-build | .worktrees/17-project-android-build-orchestrator | android packaging smoke + standard preflight |

...
- Implement an Android target adapter that consumes the shared project bundle.
- Package the bundle into Android-compatible resources/assets instead of relying on direct filesystem layouts.

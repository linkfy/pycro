...
| --- | --- | --- | --- | --- | --- | --- |
| ci-visual-payload-smoke | architecture-orchestrator | runtime-worker, platform-worker, api-worker, docs-tracker, qa-reviewer, commit-steward | in_progress | codex/06-ci-visual-payload-smoke | /Users/linkfy/Code/pycro | per docs/validation-policy.md |
